...
{
    GLint	geometryCounts;		// High nibble is vertex count, low nibble is triangle count.
    GLint	vertexIndex[15];	// Groups of 3 indexes giving the triangulation.
...
{
    GLint			geometryCounts;		// High nibble is vertex count, low nibble is triangle count.
    GLint	        vertexIndex[36];	// Groups of 3 indexes giving the triangulation.
...
GLint regularVertexData[256][12] =
        {
                {},
...
GLint transitionVertexData[512][12] =
        {
                {},
